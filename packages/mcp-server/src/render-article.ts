...
const themeMap: Record<string, string> = {
  ...
  blue: loadCSSFile(`blue.css`),
  blueCyan: loadCSSFile(`blueCyan.css`),
  blueMountain: loadCSSFile(`blueMountain.css`),
  cuteGreen: loadCSSFile(`cuteGreen.css`),
  cyan: loadCSSFile(`cyan.css`),
  extremeBlack: loadCSSFile(`extremeBlack.css`),
  fullStackBlue: loadCSSFile(`fullStackBlue.css`),
  geekBlack: loadCSSFile(`geekBlack.css`),
  green: loadCSSFile(`green.css`),
  ink: loadCSSFile(`ink.css`),
  nightPurple: loadCSSFile(`nightPurple.css`),
  orangeHeart: loadCSSFile(`orangeHeart.css`),
  purple: loadCSSFile(`purple.css`),
  red: loadCSSFile(`red.css`),
  rose: loadCSSFile(`rose.css`),
  scienceBlue: loadCSSFile(`scienceBlue.css`),
  shanchui: loadCSSFile(`shanchui.css`),
  wechatFormat: loadCSSFile(`wechatFormat.css`),
}
